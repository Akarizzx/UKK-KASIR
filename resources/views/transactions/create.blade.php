                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control @error('type') is-invalid @enderror" 
                                ...
                                <option value="sale" @if(old('type') == 'sale') selected @endif>Sale</option>
                                <option value="return" @if(old('type') == 'return') selected @endif>Return</option>
                            </select>
                            @error('type')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <h5 id="unit_price">Rp 0</h5>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Total Price</label>
                                    <h5 id="total_price" style="color: #667eea;">Rp 0</h5>
                                </div>
                            </div>
                        </div>
                    </div>
